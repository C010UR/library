...
const FloatingNav = ({ navItems }: { navItems: NavbarLink[] }) => {
  ...
  useMotionValueEvent(scrollYProgress, 'change', (current) => {
    ...
    if (typeof current !== 'number' || scrollY.get() <= 0.0) {
      return;
    }
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="flex max-w-fit fixed top-5 inset-x-0 mx-auto border rounded-full bg-muted shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-10 pr-2 pl-8 py-2 items-center justify-center space-x-4"
      >
